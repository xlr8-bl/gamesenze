...
export default function PageHead({
  ...
  title,
  lede,
  /** A competition key, to draw that competition's photography behind it. */
  photoFrom,
  children,
}: {
  eyebrow?: string;
  ...
  const photo = photoFrom ? competitionPhoto(photoFrom) : null;
  return (
    <div
    ...
    >
      {photo && <img src={photo} alt="" aria-hidden loading="eager" />}
      <div className="shell" style={{ padding: "var(--s-7) var(--s-4) var(--s-6)", position: "relative" }}>
        {eyebrow && (
